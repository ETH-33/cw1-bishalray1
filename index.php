...
<!-- Carousel  -->
       ...
       <div class="carousel-inner">
         <div class="carousel-item active">
           ...
           <div class="carousel-caption d-none d-md-block">
               <h1 class="display-5">Radiant Illumination</h1>
               <p>Elevate your hotel's online presence with our captivating light effect. This stunning visual feature casts a warm and welcoming glow, creating an inviting ambiance that entices potential guests.</p>
             </div>
         </div>
         <div class="carousel-item ">
           <img class="d-block w-100" src="assets/picture/cesourel/location.jpg" alt="First slide">
           <div class="carousel-caption d-none d-md-block">
               <h1 class="display-5 text-dark">Well-connected roads and transportation system</h1>
               <p class="text-dark">Discover a well-connected network of roads and transportation systems that seamlessly connect cities, towns, and destinations. Our region boasts a modern and efficient infrastructure, designed to facilitate easy travel and efficient logistics.</p>
             </div>
         </div>
         <div class="carousel-item ">
           <img class="d-block w-100" src="assets/picture/cesourel/Parking.jpg" alt="First slide">
           <div class="carousel-caption d-none d-md-block">
               <h1 class="display-5 text-dark">Ample Parking Space</h1>
               <p class="text-dark">Our facility offers a generous and well-designed parking area with sufficient capacity to accommodate a large number of vehicles. You can enjoy the convenience of easily finding a spot to park your car without any hassle.</p>
             </div>
         </div>
         <div class="carousel-item ">
           <img class="d-block w-100" src="assets/picture/cesourel/Reception.jpg" alt="First slide">
           <div class="carousel-caption d-none d-md-block">
               <h1 class="display-5">Welcoming Experience</h1>
 ...
 <section class="py-5 white-section" id="introduction" >
   <div class="container">
     <h1 class="display-4 title"><?php echo $general_setting['Name'] ?>,luxury collections ,Lahan</h1>
     <p class="lead">A premier accommodation offering stylish rooms, excellent amenities, and exceptional service for an unforgettable stay.</p>
   </div>
   ...
   <div class="container"> 
           ...
           <p class="text-justify">Bishal Hotel is a premier destination for travelers seeking a luxurious and memorable stay. Located in a prime location, the hotel offers stylishly designed rooms, top-notch amenities, and exceptional service. With a range of facilities including a fitness center, spa, and on-site restaurant, Bishal Hotel promises a comfortable and indulgent experience for all guests.</p>

               <p><blockquote class="blockquote">Ideal Location</blockquote>

               Bishal Hotel enjoys an ideal location that sets it apart as a prime destination for travelers. Situated in a vibrant and convenient area, the hotel offers easy access to key attractions, business centers, and transportation hubs. Whether guests are exploring the city's landmarks or attending important meetings, Bishal Hotel's central location ensures a seamless and efficient experience. Additionally, the surrounding neighborhood is known for its bustling energy, diverse dining options, and shopping opportunities, further enhancing the overall convenience and appeal of Bishal Hotel's location.
               </p>
                       
               <p>     
               <blockquote class="blockquote">Refined Artistry at Bishal Hotel</blockquote>
               Immerse yourself in a world of elegant sophistication and impeccable craftsmanship. From the meticulously curated artwork adorning the walls to the intricately designed furnishings, Bishal Hotel embodies a true masterpiece of refined artistry. Every detail has been thoughtfully considered, creating a harmonious blend of aesthetics and comfort that elevates the guest experience to new heights. Prepare to be enchanted by the exquisite fusion of artistic expression and luxurious accommodations at Bishal Hotel.
               </p>
