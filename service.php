  ...
  <section class="white-section container">
        ...
        <div class="row featurette">
          <div class="col-md-7 p-5 mt-4">
            ...
            <p class="lead">Ten distinct dining destinations featuring Nepali well appreciated and prized beverages.</p>
          </div>
          <div class="col-md-5">
        ...
        <div class="row featurette">
          <div class="col-md-7 order-md-2 p-5 mt-4">
            ...
            <p class="lead">With 506 rooms, 78 luxuriously appointed service apartments & 16 palatial suites which are the epitome of Nepali grace and style.</p>
          </div>
